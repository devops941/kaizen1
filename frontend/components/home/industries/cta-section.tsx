    ...
    >
      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Eyebrow */}
          <div className="cta-content flex items-center justify-center gap-4 mb-8">
          ...
          {/* Title */}
          <h2 className="cta-content text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light tracking-tight leading-[1.05] mb-8">
            <span className="block text-white">Let&apos;s Build Your</span>
            <span className="block text-[#c8b4a0]">Industry&apos;s Next</span>
            <span className="block text-white/80">Success Story</span>
          </h2>

          {/* Description */}
          <p className="cta-content text-base md:text-lg text-white/80 leading-relaxed max-w-2xl mx-auto mb-12 font-light">
            Whether you&apos;re in education, healthcare, manufacturing, or any other industry — 
            we have the expertise to transform your operations with tailored technology solutions.
          </p>

          {/* CTA Buttons */}
          <div className="cta-content flex flex-wrap items-center justify-center gap-4 mb-16">
            <AnimatedButton
              px="px-8"
              py="py-5"
          ...
          {/* Trust Indicators */}
          <div className="cta-content flex flex-wrap items-center justify-center gap-8 text-xs font-mono text-white/60">
            ...
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-[#c8b4a0]" />
              <span>Custom Modular Solutions</span>
            </div>
          </div>
        </div>
      </div>
